  ...
  render() {
    return (
      <nav className="footer cMe">
        <a href="https://github.com/nnguy152"><i className="fab fa-github"></i></a> |
        <a href="https://www.linkedin.com/in/nnguy152/"><i className="fab fa-linkedin"></i></a>
        <p className="cMe">&#169;	Nhi Nguyen 2018</p>
